...
| 3 | Permission Engine & Backend Management APIs | R3: Dynamic permission authorization handler/policy, Roles & Permissions CRUD endpoints, User Management endpoints (GET, POST, PUT, deactivate, reactivate, role assignment) | M2 | IN_PROGRESS |
